...
const ProjcetCarousel = () => {
    const [blogs, setBlogs] = useState<Blog[]>([]);
    const tagId = "cmq36n38rd6dk0cqbzb1qqz7";
    useEffect(() => {
    ...
    return (
        <div className="blog-carousel">
            ...
            <h3 className="text-lg md:text-2xl text-gray-500 border-b border-[#2c3e50] pb-4 mb-5">Blog เกี่ยวกับโปรเจคที่เคยทำ</h3>
            <Swiper
...
export default ProjcetCarousel;
