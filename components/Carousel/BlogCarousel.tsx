"use client"; // ใช้กับ Next.js App Router
import "swiper/css";
...
const BlogCarousel = () => {
    ...
    useEffect(() => {
        async function fetchBlogs() {
            const res = await fetch(`${process.env.NEXT_PUBLIC_STRAPI_BASE_URL}/api/blogs?pagination[page]=1&pagination[pageSize]=5&populate[0]=tags&populate[1]=Images_cover&sort[0]=createdAt:desc`);
    ...
    return (
        <div className="blog-carousel">
            ...
            <h3 className="text-lg md:text-2xl text-gray-500 border-b border-[#2c3e50] pb-4 mb-5">Blog ล่าสุด</h3>
            <Swiper
                        ...
                        <div className="blog-card">
                            <a href={`blogs/${blog.documentId}`}>
                                <Image
                                    ...
                                    placeholder="blur" // ✅ โหลดภาพเบลอก่อนแสดง
